...
namespace WhenPlugin.When.Sequencer.Trigger
{
    ...
    public class SmartMeridianFlipTrigger : MeridianFlipTrigger {
        ...
        protected TimeSpan MaximumProximalHourAngle(Coordinates target, bool above) {
            ...
            double hourAngle;
            if (above) {
                hourAngle = Symbol.WhenPluginObject.Obstructions.GetWestObstruction(target.Dec);
            } else {
                hourAngle = Symbol.WhenPluginObject.Obstructions.GetEastObstruction(180 - target.Dec);
            }
        ...
        protected TimeSpan MinimumDistalHourAngle(Coordinates target, bool above) {
            ...
            double hourAngle;
            if (above) {
                hourAngle = Symbol.WhenPluginObject.Obstructions.GetEastObstruction(target.Dec);
            } else {
                hourAngle = Symbol.WhenPluginObject.Obstructions.GetWestObstruction(180 - target.Dec);
            }
